      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        {(
          [
            ...
            { label: "Freigegeben", key: "approved", color: "bg-slate-50 text-hg-steel" },
                ...
                <tr key={row.id} className="hover:bg-slate-50">
                  <td className="px-4 py-3">
                    ...
                    <Link
                      ...
                      className="text-xs text-hg-steel hover:underline"
                    >
                      Schadenakte →
                    </Link>
                  </td>
                  <td className="px-4 py-3 font-mono text-xs text-slate-600">
                    <Link
                      ...
                      className="hover:text-hg-steel hover:underline"
                    >
