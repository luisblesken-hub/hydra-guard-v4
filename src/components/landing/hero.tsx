    ...
    >
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100svh-4rem)] max-w-6xl items-center gap-10 px-6 py-16 sm:py-20 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-12">
        <div className="hg-landing-rise">
          <p className="text-[11px] font-medium tracking-[0.14em] text-[#9aa8b0] uppercase">
            Early Access · Pilot Aachen
          </p>
          <p
            id="landing-brand"
            className="mt-4 max-w-4xl text-[clamp(3rem,8.5vw,5.75rem)] font-semibold leading-[0.92] tracking-tight text-white"
          >
            HydraGuard
          </p>
        ...
        <div className="hg-landing-rise relative hidden lg:block" style={{ animationDelay: "120ms" }}>
          <ProductMock className="w-full rotate-[-1.5deg]" />
        </div>
